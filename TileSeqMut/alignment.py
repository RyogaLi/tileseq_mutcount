...
def align_main(ref, r1, r2, sam_path, shfile):
    ...
    r1_cmd = f"bowtie2 --no-head --norc --no-sq --rdg 12,1 --rfg 12,1 --local -p 8 -x {ref} -U {r1} -S {r1_sam_file}"
    r2_cmd = f"bowtie2 --no-head --nofw --no-sq --rdg 12,1 --rfg 12,1 --local -p 8 -x {ref} -U {r2} -S {r2_sam_file}"
